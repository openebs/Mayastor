...
We also provide a [simple script](https://github.com/openebs/mayastor-extensions/blob/HEAD/scripts/helm/install.sh) to deploy a non-production the mayastor helm chart testing:
