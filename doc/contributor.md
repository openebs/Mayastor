...
Each repo has its own CI system which is currently a mix of [Jenkins][jenkins] and [GitHub Actions][github-actions].
...
For the Jenkins pipeline you can refer to the `./Jenkinsfile` on each repo.
...
> _**CI**_\
> Let us know if you'd like to help with this effort
