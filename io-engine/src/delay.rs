...
use spdk_rs::libspdk::{spdk_poller, spdk_poller_register, spdk_poller_unregister};
...
pub fn register() {
    ...
    let delay_poller = unsafe { spdk_poller_register(Some(sleep), std::ptr::null_mut(), 1000) };
